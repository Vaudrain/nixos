...
rustPlatform.buildRustPackage rec {
  ...
  # Copy to both locations to pass checks
  postInstall = ''
  mkdir -p $out/lib/mozilla/native-messaging-hosts
  mkdir -p $out/lib/floorp/native-messaging-hosts
  ...
  cp manifest/manifest-linux.json $out/lib/floorp/native-messaging-hosts/ax.nd.profile_switcher_ff.json
  '';
